      ...
      <el-card class="box-card">
        <el-form ref="challengeInfo" label-positon="left" :rules="addChallengeRules" :model="challengeInfo" label-width="120px">
          ...
          <el-form-item class="form-button">
            <el-button type="primary" @click="createChallenge">提交</el-button>
...
import { fetchAllChallenge, createChallenge } from '@/api/challenge'
  ...
  data() {
    return {
      ...
      challengeInfo: {
        ...
        description: '',
        blockType: '基础',
        preconditionTotalScore: undefined,
        preconditionBlocks: [],
        challengeProblems: []
      },
      blockTypeOptions: [
  ...
  methods: {
    ...
    createChallenge() {
      this.$refs.challengeInfo.validate(valid => {
        if (valid) {
          this.listLoading = true
          this.challengeInfo.id = this.challengeList[this.challengeList.length - 1].id + 1
